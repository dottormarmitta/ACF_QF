...
public class ProductGamma {
	public static void main(String[] args) {
		...
		double today = 0.0;
		double maturity  = 2.0;
		int timeIntervals = 24; // Each month for 2 years
		...
		double th = -0.7678;
		double nu = 0.0622;
		System.out.println(" Theta: " + th + ", Nu: " + nu);
		MultidimensionalDriver gamma = new MultiGammaProcess(nu, 20);
		MultiStockProcess myStocks = new GeneralVarianceGamma(ones, vols, gamma, brownian, rf, th, nu, myTenor, 20);
		// I build my product:
		double def = 0.20;
