...
public class ProductValueFromRates implements FinancialProduct {
	...
	// Coupon rates:
	private final double juniorRate;
	private final double mezzanRate;
	private final double seniorRate;
	...
	// Constructor:
	public ProductValueFromRates(double rates[], double maturity, double defThresh, double rfr, int numberOfSimulations, double[] vols, double[][] cholesky) {
		this.juniorRate = rates[0];
		this.mezzanRate = rates[1];
		this.seniorRate = rates[2];
