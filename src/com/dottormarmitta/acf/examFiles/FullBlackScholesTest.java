...
public class FullBlackScholesTest {
	...
	public static void main(String[] args) {
		...
		double today = 0.0;
		double maturity = 0.0;
		System.out.print("What is the option maturity? ");
		...
		double strike = 0.0;
		System.out.println();
		System.out.print("Enter the option strike (recall stocks initial value is 1.0): ");
		strike = s.nextDouble();
		int assetNumber = 0;
		System.out.println();
		System.out.print("Enter the asset number (from 1 to 20), underlying of the option: ");
		assetNumber = s.nextInt() - 1;
		int ns = 0;
		System.out.println();
		...
		CallOption myCall = new CallOption(myBsStocks, strike, assetNumber, zcbc);
		double analyticCall = BlackScholesAnalytic.analyticCall(1.0, rf, vol[assetNumber], strike, maturity);
		double monteCarlo = myCall.getMCValue(ns);
		System.out.println("Monte Carlo value: " + monteCarlo);
		System.out.println("Analytic value:    " + analyticCall);
	}
