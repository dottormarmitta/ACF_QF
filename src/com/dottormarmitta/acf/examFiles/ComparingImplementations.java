...
public class ComparingImplementations {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tested algorithm results are: ");
		printProperVector(tested);
		System.out.println("It took: " + timeElapsed/1000 + " s");
		System.out.println();
		
		System.out.println("Fast algorithm results are: ");
		printProperVector(fast);
		System.out.println("It took: " + timeElapsed1/1000+ " s");
		System.out.println();
	}
